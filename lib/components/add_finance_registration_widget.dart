...
import 'add_finance_registration_model.dart';
export 'add_finance_registration_model.dart';

class AddFinanceRegistrationWidget extends StatefulWidget {
  const AddFinanceRegistrationWidget({super.key});

  @override
  State<AddFinanceRegistrationWidget> createState() =>
      _AddFinanceRegistrationWidgetState();
}

class _AddFinanceRegistrationWidgetState
    extends State<AddFinanceRegistrationWidget> {
  late AddFinanceRegistrationModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddFinanceRegistrationModel());
