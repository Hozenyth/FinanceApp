...
import 'finance_app_auth_model.dart';
export 'finance_app_auth_model.dart';

class FinanceAppAuthWidget extends StatefulWidget {
  const FinanceAppAuthWidget({super.key});

  @override
  State<FinanceAppAuthWidget> createState() => _FinanceAppAuthWidgetState();
}

class _FinanceAppAuthWidgetState extends State<FinanceAppAuthWidget>
    with TickerProviderStateMixin {
  late FinanceAppAuthModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FinanceAppAuthModel());
